...
export default function EditVideoLesson({
    ...
    const { data, setData, patch, processing, errors } = useForm({
        ...
        lesson_date: videoLesson.lesson_date,
        order_index: videoLesson.order_index,
        kinescope_video_id: videoLesson.kinescope_video_id,
        is_active: videoLesson.is_active,
        group_ids: videoLesson.groups.map((g) => g.id),
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        patch(`/admin/video-lessons/${videoLesson.id}`);
    };
    ...
    return (
        <AppLayout>
            <Head title="Редактировать видеоурок" />
